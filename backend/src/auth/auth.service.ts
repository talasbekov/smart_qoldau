...
export class AuthService {
  ...
  async requestCode(phone: string): Promise<void> {
    ...
    // Шесть цифр, а не четыре: у четырёхзначного кода 13 бит энтропии, и
    // при живых лимитах (3 кода в час + 10 проверок за 15 минут на номер)
    // угадывание за месяц становится реалистичным. Шесть цифр — ~20 бит,
    // нижняя граница OWASP ASVS 4.0 V2.7.6 для одноразовых кодов.
