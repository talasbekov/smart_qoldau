...
/// значение (расхождение №1, закрытое решением Р-08: 2 990 ₸/мес и
/// 23 900 ₸/год, единый список преимуществ). Прототип в этой части
...
class PlanComparison extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final premium = _PlanCard(
      ...
      // 2 990 ₸ — Р-08. Формат суммы общий для всего продукта.
      price: '${formatTenge(299000)} / ${l10n.premiumPlanMonth.toLowerCase()}',
