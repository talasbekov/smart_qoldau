...
class _CodeScreenState extends ConsumerState<CodeScreen> {
  ...
  Future<void> _resend() async {
    ...
    try {
      ...
      // Перезапускаем отсчёт в любом случае — включая SMS_RATE_LIMITED
      // (Р-10/ТЗ §5.1): пользователь и так не может отправить запрос чаще
      // 45 секунд, и лучше показать это оставшееся время, чем оставить
