...
void main() {
  ...
  testWidgets('разделов без экранов в меню нет', (tester) async {
    ...
    // «Поддержка» больше не в списке отсутствующих: экран для эксперта
    // сделан (E14), а бэкенд экспертные категории тикетов поддерживал
    // давно. Остались «Клиенты», «Чаты» и «Настройки» — расхождения
    // №10 и №12.
    for (final missing in ['clients', 'chats', 'settings']) {
